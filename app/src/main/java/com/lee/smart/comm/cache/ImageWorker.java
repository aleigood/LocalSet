...
public abstract class ImageWorker {
     ...
     */
    public void addImageCache(Activity activity, ImageCache.ImageCacheParams cacheParams) {
        mImageCacheParams = cacheParams;

        if (activity instanceof Cachable) {
            mImageCache = ImageCache.getInstance((Cachable) activity, mImageCacheParams);
            new CacheAsyncTask().execute(MESSAGE_INIT_DISK_CACHE);
        } else {
            Log.e(TAG, "ImageWorker can't be init, the activity must be cachable");
        }
    }
