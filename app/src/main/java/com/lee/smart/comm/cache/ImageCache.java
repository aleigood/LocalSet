...
package com.lee.smart.comm.cache;
...
import com.lee.smart.BuildConfig;
...
public class ImageCache {
     ...
     */
    public static ImageCache getInstance(Cachable activity, ImageCacheParams cacheParams) {
        // See if we already have an ImageCache stored in RetainFragment
        ImageCache imageCache = activity.getCache();

        // No existing ImageCache, create one and store it in RetainFragment
        if (imageCache == null) {
            imageCache = new ImageCache(cacheParams);
            activity.setCache(imageCache);
        }
    ...
    public static class ImageCacheParams {
         ...
         * @param diskCacheDirectoryName A unique subdirectory name that will be appended to the application cache directory. Usually
         ...
         * percent is < 0.05 or > .8. memCacheSize is stored in kilobytes instead of bytes as this will eventually be
